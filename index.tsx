...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Solana Click Game</title>
        <meta name="description" content="Solana Click Game" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main className={styles.main}>
        <h1 className={styles.title}>Solana Click Game</h1>
        <div className={styles.logo}>
          <img src="https://www.cursor.cc/cursor3d/66859.png" alt="Logo" />
        </div>
        {!isConnected ? (
